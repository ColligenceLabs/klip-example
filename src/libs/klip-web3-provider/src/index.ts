...
export class KlipWeb3Provider extends SafeEventEmitter implements Web3Provider {
    ...
    private async _eth_requestAccounts(): Promise<JSONRPCResponse> {
        ...
        // }
        // const accounts = await this.caver.klay.getAccounts();
        // console.log('!!!!!!! account = ', accounts);
        // return { jsonrpc: '2.0', id: 0, result: accounts };
        return { jsonrpc: '2.0', id: 0, result: this._eth_accounts() };
    }
